...
Produce the result as markdown and save it to this file: ${outputPath}

You may also save additional files (images, HTML, CSV, JSON, SVG) to the attachments directory: ${attachmentsDir}/
